...
![Покупка билета](./Снимок%20экрана%202024-10-15%20101334.png)
...
Скриншот элемента: ![Изображение с формой оплаты](./Снимок%20экрана%202024-10-15%20101334.png)
...
| Добавление багажа | Клик по кнопке "Добавить" | POST /add-baggage | Обновление стоимости и данных о багаже |
